...
STR_OPT(sts)			// Target sequence hit segments in FASTA format.
STR_OPT(st)				// 

STR_OPT(output)			// Output filename
STR_OPT(pctidout)		// Output filename
STR_OPT(spacingout)		// Output filename
...
STR_OPT(mockhits)
STR_OPT(sslots)
STR_OPT(constabbedout)
STR_OPT(wintabbedout)
...
UNS_OPT(s,					0,			0,			UINT_MAX)	// -
UNS_OPT(slo,				0,			0,			UINT_MAX)	// -
UNS_OPT(shi,				0,			0,			UINT_MAX)	// -
UNS_OPT(tlo,				0,			0,			UINT_MAX)	// -
UNS_OPT(thi,				0,			0,			UINT_MAX)	// -
UNS_OPT(wlo,				0,			0,			UINT_MAX)	// -
UNS_OPT(whi,				0,			0,			UINT_MAX)	// -
UNS_OPT(t,					0,			0,			UINT_MAX)	// -
UNS_OPT(w,					0,			0,			UINT_MAX)	// -
UNS_OPT(d,					0,			0,			UINT_MAX)	// -
UNS_OPT(ds,					0,			0,			UINT_MAX)	// -
UNS_OPT(pctid,				0,			0,			UINT_MAX)	// -
UNS_OPT(pctidlo,			0,			0,			UINT_MAX)	// -
UNS_OPT(pctidhi,			0,			0,			UINT_MAX)	// -
UNS_OPT(pctidinc,			0,			0,			UINT_MAX)	// -
UNS_OPT(seqlength,			0,			0,			UINT_MAX)	// -
...
// uchime
UNS_OPT(window,				2,			2,			UINT_MAX)	// Max number of parents to consider.
...
FLT_OPT(load_factor,		0.6,		0.0,		100.0)
